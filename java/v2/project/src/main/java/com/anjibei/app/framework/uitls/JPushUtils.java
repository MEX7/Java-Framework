...
public class JPushUtils {
    ...
    private static final String appKey ="f36a24be1ea5cd399aa0f881";
    private static final String masterSecret = "9308ba1331712fe76318036e";

    public static final String TITLE = "Anjibei";
    public static final String ALERT = "Anjibei";
...
//        PushPayload payload = buildPushObject_all_all_alert();
    ...
    public static void SendPushToAll(String message){
        JPushClient jpushClient = new JPushClient(masterSecret, appKey, 3);

        PushPayload payload = buildPushObject_ios_audienceMore_messageWithExtras(message);
        try {
            PushResult result = jpushClient.sendPush(payload);
            LOG.info("Got result - " + result);
